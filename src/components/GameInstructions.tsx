  ...
  return (
    <Card className="w-full lg:w-80 bg-card glossy border-4 border-secondary p-6 shadow-[0_8px_32px_rgba(0,255,255,0.3)] rounded-3xl">
      ...
      <div className="space-y-4 text-sm">
        <div>
          <h3 className="text-arcade-cyan font-bold mb-2 text-shadow-neon">
            🎮 CONTROLS
          </h3>
        ...
        <div>
          ...
          <ul className="space-y-1 text-muted-foreground font-semibold">
            <li>🖥️ Smash Computer</li>
            <li>🎨 Graffiti Wall</li>
            <li>🎂 Cake in Face</li>
            <li>---</li>
            <li>📝 Scare executives (sneak up behind them)</li>
          </ul>
        </div>
        ...
        <div className="pt-2 border-t border-border">
          <p className="text-xs text-muted-foreground italic font-medium">
            Avoid the executives' vision cones! Sneak up behind them to stick a
            kick-me sign!
          </p>
        </div>
